...
import com.gmail.dto.response.BaseListResponse;
import com.gmail.dto.response.ListResponse;
import com.gmail.dto.response.ListUserResponse;
import com.gmail.dto.response.PinnedListResponse;
import com.gmail.dto.response.lists.ListMemberResponse;
...
public class ListsMapperTest {
    ...
    public void getListById() {
        ...
        Assertions.assertEquals(mockBaseListResponse, listsMapper.getListById(TestConstants.LIST_ID));
    ...
    public void createTweetList() {
        ...
        Assertions.assertEquals(listUserResponse, listsMapper.createTweetList(listsRequest));
    ...
    public void editTweetList() {
        ...
        Assertions.assertEquals(baseListResponse, listsMapper.editTweetList(listsRequest));
    ...
    public void followList() {
        ...
        when(basicMapper.convertToResponse(mockListUserProjection, ListUserResponse.class)).thenReturn(listUserResponse);
        Assertions.assertEquals(listUserResponse, listsMapper.followList(TestConstants.LIST_ID));
    ...
    public void pinList() {
        ...
        Assertions.assertEquals(pinnedListResponse, listsMapper.pinList(TestConstants.LIST_ID));
    ...
    public void getTweetsByListId() {
        ...
        Assertions.assertEquals(headerResponse, listsMapper.getTweetsByListId(TestConstants.LIST_ID, pageable));
    ...
    public void getListDetails() {
        ...
        when(basicMapper.convertToResponse(mockBaseListProjection, BaseListResponse.class)).thenReturn(baseListResponse);
        Assertions.assertEquals(baseListResponse, listsMapper.getListDetails(TestConstants.LIST_ID));
