...
import com.gmail.model.PinnedList;
import com.gmail.model.User;
import com.gmail.repository.ListsRepository;
import com.gmail.repository.UserRepository;
import com.gmail.repository.projection.BaseListProjection;
import com.gmail.repository.projection.ListProjection;
import com.gmail.repository.projection.ListUserProjection;
import com.gmail.repository.projection.PinnedListProjection;
import com.gmail.service.ListsService;
...
import static com.gmail.ListsServiceTestHelper.mockUser;
...
public class ListsServiceImplTest {
    ...
    public void getListById_shouldCheckUserIsBlockedAndReturnBlockedUser() {
        ...
        ApiRequestException exception = assertThrows(ApiRequestException.class,
                () -> listsService.getListById(TestConstants.LIST_ID));
        assertEquals(String.format(ErrorMessage.USER_ID_BLOCKED, 2L), exception.getMessage());
        assertEquals(HttpStatus.BAD_REQUEST, exception.getStatus());
    }

    @Test
    public void getListById_shouldReturnListNotFound() {
        when(listsRepository.getListById(TestConstants.LIST_USER_ID, TestConstants.USER_ID, BaseListProjection.class)).thenReturn(Optional.empty());
        ApiRequestException exception = assertThrows(ApiRequestException.class, () -> listsService.getListById(TestConstants.LIST_USER_ID));
    ...
    public void addUserToLists_shouldCheckUserIsBlockedAndReturnBlockedUser() {
        ...
        assertEquals(String.format(ErrorMessage.USER_ID_BLOCKED, listsRequest.getUserId()), exception.getMessage());
        assertEquals(HttpStatus.BAD_REQUEST, exception.getStatus());
    }
    ...
    public void addUserToLists_shouldCheckUserIsBlockedMyProfileAndReturnBlockedUser() {
        ...
        ApiRequestException exception = assertThrows(ApiRequestException.class,
                () -> listsService.addUserToLists(listsRequest));
        assertEquals(String.format(ErrorMessage.USER_ID_BLOCKED, TestConstants.USER_ID), exception.getMessage());
        assertEquals(HttpStatus.BAD_REQUEST, exception.getStatus());
    }
    ...
    public void addUserToList_shouldCheckUserIsBlockedAndReturnBlockedUser() {
        ...
        assertEquals(String.format(ErrorMessage.USER_ID_BLOCKED, 1L), exception.getMessage());
        assertEquals(HttpStatus.BAD_REQUEST, exception.getStatus());
    }
    ...
    public void getTweetsByListId() {
        ...
        Assertions.assertEquals(headerResponse, listsService.getTweetsByListId(TestConstants.LIST_ID, pageable));
    ...
    public void searchListMembersByUsername() {
        List<User> users = List.of(mockUser(1L), mockUser(2L));
        when(userRepository.searchListMembersByUsername(PathConstants.USERNAME)).thenReturn(users);
        assertNotNull(listsService.searchListMembersByUsername(TestConstants.LIST_ID, PathConstants.USERNAME));
        verify(userRepository, times(1)).searchListMembersByUsername(PathConstants.USERNAME);
    }
}
