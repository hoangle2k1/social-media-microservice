...
import com.gmail.dto.request.ListsRequest;
import com.gmail.dto.request.UserToListsRequest;
...
public class ListsControllerTest {
    ...
    public void getAllTweetLists() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(PathConstants.UI_V1_LISTS)
    ...
    public void getUserTweetLists() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(PathConstants.UI_V1_LISTS + PathConstants.USER)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isOk())
    ...
    public void getUserTweetListsById() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(PathConstants.UI_V1_LISTS + PathConstants.USER_USER_ID, TestConstants.USER_ID)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isOk())
    ...
    public void getTweetListsWhichUserIn() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(PathConstants.UI_V1_LISTS + PathConstants.USER_CONSIST)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$[*]", hasSize(1)))
    ...
    public void getUserPinnedLists() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(PathConstants.UI_V1_LISTS + PathConstants.PINED)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isOk())
    ...
    public void getListById() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(PathConstants.UI_V1_LISTS + PathConstants.LIST_ID, 4)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isOk())
    ...
    public void getOwnerPrivateListById() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(PathConstants.UI_V1_LISTS + PathConstants.LIST_ID, 6)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isOk())
    ...
    public void getFollowedPrivateListById() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(PathConstants.UI_V1_LISTS + PathConstants.LIST_ID, 7)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isOk())
    ...
    public void getPrivateListById_NotFound() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(PathConstants.UI_V1_LISTS + PathConstants.LIST_ID, 8)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isNotFound())
                .andExpect(jsonPath("$", Matchers.is(ErrorMessage.LIST_NOT_FOUND)));
    }
    ...
    public void getBlockedUserByListId() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(PathConstants.UI_V1_LISTS + PathConstants.LIST_ID, 10)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isBadRequest())
                .andExpect(MockMvcResultMatchers.jsonPath("$", Matchers.is(String.format(ErrorMessage.USER_ID_BLOCKED, 2))));
    }
    ...
    public void getPrivateUserProfileByListId() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(PathConstants.UI_V1_LISTS + PathConstants.LIST_ID, 11)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isNotFound())
    ...
    public void createTweetList() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.post(PathConstants.UI_V1_LISTS)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID)
    ...
    public void createTweetList_ShouldListNameLengthIs0Symbols() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.post(PathConstants.UI_V1_LISTS)
                        ...
                        .contentType(MediaType.APPLICATION_JSON_VALUE))
                .andExpect(status().isBadRequest())
                .andExpect(jsonPath("$", Matchers.is(ErrorMessage.INCORRECT_LIST_NAME_LENGTH)));
    }
...
//    }
    ...
    public void editTweetList() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.put(PathConstants.UI_V1_LISTS)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID)
                        .content(mapper.writeValueAsString(listsRequest))
                        .contentType(MediaType.APPLICATION_JSON_VALUE))
                .andExpect(status().isOk())
...
//    }
    ...
    public void deleteList() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.delete(PathConstants.UI_V1_LISTS + PathConstants.LIST_ID, 4)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isOk())
...
//    }
    ...
    public void followList() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(PathConstants.UI_V1_LISTS + PathConstants.FOLLOW_LIST_ID, 9)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isOk())
    ...
    public void followList_ShouldListNotFound() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(PathConstants.UI_V1_LISTS + PathConstants.FOLLOW_LIST_ID, 99)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isNotFound())
                .andExpect(jsonPath("$", Matchers.is(ErrorMessage.LIST_NOT_FOUND)));
    }
    ...
    public void followList_ShouldFollowToPrivateListNotFound() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(PathConstants.UI_V1_LISTS + PathConstants.FOLLOW_LIST_ID, 8)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isNotFound())
                .andExpect(jsonPath("$", Matchers.is(ErrorMessage.LIST_NOT_FOUND)));
    }
    ...
    public void unfollowList() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(PathConstants.UI_V1_LISTS + PathConstants.FOLLOW_LIST_ID, 4)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.id").value(4))
                .andExpect(jsonPath("$.listName").value(TestConstants.LIST_NAME))
    ...
    public void pinList() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(PathConstants.UI_V1_LISTS + PathConstants.PIN_LIST_ID, 6)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.id").value(6))
                .andExpect(jsonPath("$.listName").value(TestConstants.LIST_NAME))
    ...
    public void unpinList() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(PathConstants.UI_V1_LISTS + PathConstants.PIN_LIST_ID, 4)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.id").value(4))
                .andExpect(jsonPath("$.listName").value(TestConstants.LIST_NAME))
    ...
    public void pinList_ShouldPinnedListNotFound() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(PathConstants.UI_V1_LISTS + PathConstants.PIN_LIST_ID, 8)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isNotFound())
                .andExpect(jsonPath("$", Matchers.is(ErrorMessage.LIST_NOT_FOUND)));
    }
    ...
    public void getListsToAddUser() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(PathConstants.UI_V1_LISTS + PathConstants.ADD_USER_USER_ID, 1)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$[*]", hasSize(2)))
    ...
    public void addUserToLists() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.post(PathConstants.UI_V1_LISTS + PathConstants.ADD_USER)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID)
    ...
    public void addUserToLists_ShouldUserIsBlocked() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.post(PathConstants.UI_V1_LISTS + PathConstants.ADD_USER)
                        ...
                        .contentType(MediaType.APPLICATION_JSON_VALUE))
                .andExpect(status().isBadRequest())
                .andExpect(MockMvcResultMatchers.jsonPath("$", Matchers.is(String.format(ErrorMessage.USER_ID_BLOCKED, 4))));
    }
    ...
    public void getTweetsByListId() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(PathConstants.UI_V1_LISTS + PathConstants.LIST_ID_TWEETS, 4)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$[*]", hasSize(1)))
    ...
    public void getTweetsByUserPrivateListId() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(PathConstants.UI_V1_LISTS + PathConstants.LIST_ID_TWEETS, 5)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isNotFound())
                .andExpect(jsonPath("$", Matchers.is(ErrorMessage.LIST_NOT_FOUND)));
    }
    ...
    public void getListDetails() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(PathConstants.UI_V1_LISTS + PathConstants.LIST_ID_DETAILS, 4)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.id").value(4))
                .andExpect(jsonPath("$.listName").value(TestConstants.LIST_NAME))
    ...
    public void getListDetailsByUserPrivateList() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(PathConstants.UI_V1_LISTS + PathConstants.LIST_ID_DETAILS, 5)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isNotFound())
                .andExpect(jsonPath("$", Matchers.is(ErrorMessage.LIST_NOT_FOUND)));
    }
