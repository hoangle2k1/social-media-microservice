...
public class TweetApiControllerTest {
    ...
    public void getTweetsByIds() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.post(PathConstants.API_V1_TWEETS + PathConstants.IDS)
    ...
    public void getTweetsByUserIds() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.post(PathConstants.API_V1_TWEETS + PathConstants.USER_IDS)
    ...
    public void getTweetById() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(PathConstants.API_V1_TWEETS + PathConstants.TWEET_ID, 43)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isOk())
    ...
    public void getNotificationTweet() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(PathConstants.API_V1_TWEETS + PathConstants.NOTIFICATION_TWEET_ID, 43)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isOk())
    ...
    public void isTweetExists() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(PathConstants.API_V1_TWEETS + PathConstants.ID_TWEET_ID, 43)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isOk())
    ...
    public void getTweetCountByText() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(PathConstants.API_V1_TWEETS + PathConstants.COUNT_TEXT, "test")
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isOk())
    ...
    public void getChatTweet() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(PathConstants.API_V1_TWEETS + PathConstants.CHAT_TWEET_ID, 43)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.id").value(43L))
                .andExpect(jsonPath("$.text").value(TestConstants.TWEET_TEXT))
