...
public class BookmarkControllerTest {
    ...
    public void getUserBookmarks() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(PathConstants.UI_V1_TWEETS + PathConstants.USER_BOOKMARKS)
    ...
    public void processUserBookmarks_addBookmark() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(PathConstants.UI_V1_TWEETS + PathConstants.USER_BOOKMARKS_TWEET_ID, 43)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isOk())
    ...
    public void processUserBookmarks_removeBookmark() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(PathConstants.UI_V1_TWEETS + PathConstants.USER_BOOKMARKS_TWEET_ID, 40)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isOk())
    ...
    public void processUserBookmarks_ShouldTweetNotFound() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(PathConstants.UI_V1_TWEETS + PathConstants.USER_BOOKMARKS_TWEET_ID, 99)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
    ...
    public void processUserBookmarks_ShouldTweetDeleted() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(PathConstants.UI_V1_TWEETS + PathConstants.USER_BOOKMARKS_TWEET_ID, 49)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
    ...
    public void getIsTweetBookmarked() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(PathConstants.UI_V1_TWEETS + PathConstants.TWEET_ID_BOOKMARKED, 43)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$").value(false));
    }
