...
public class TweetControllerTest {
    ...
    public void getTweets() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(PathConstants.UI_V1_TWEETS)
    ...
    public void getTweetById() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(PathConstants.UI_V1_TWEETS + PathConstants.TWEET_ID, 43)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isOk())
    ...
    public void getTweetById_ShouldNotFound() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(PathConstants.UI_V1_TWEETS + PathConstants.TWEET_ID, 99)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isNotFound())
                .andExpect(jsonPath("$", Matchers.is(ErrorMessage.TWEET_NOT_FOUND)));
    }

    @Test
    @DisplayName("[400] GET /ui/v1/tweets/49 - Should tweet deleted")
    public void getTweetById_ShouldTweetDeleted() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(PathConstants.UI_V1_TWEETS + PathConstants.TWEET_ID, 49)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isBadRequest())
                .andExpect(jsonPath("$", Matchers.is(ErrorMessage.TWEET_DELETED)));
    }
    ...
    public void getTweetById_ShouldUserHavePrivateProfile() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(PathConstants.UI_V1_TWEETS + PathConstants.TWEET_ID, 50)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isNotFound())
                .andExpect(jsonPath("$", Matchers.is(ErrorMessage.USER_NOT_FOUND)));
    }

    @Test
    @DisplayName("[400] GET /ui/v1/tweets/51 - Should User blocked")
    public void getTweetById_ShouldUserBlocked() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(PathConstants.UI_V1_TWEETS + PathConstants.TWEET_ID, 51)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isBadRequest())
                .andExpect(jsonPath("$", Matchers.is(ErrorMessage.USER_PROFILE_BLOCKED)));
    }

    @Test
    @DisplayName("[200] GET /ui/v1/tweets/user/2 - Get user tweets by id")
    public void getUserTweets() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(PathConstants.UI_V1_TWEETS + PathConstants.USER_USER_ID, TestConstants.USER_ID)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$[*]", hasSize(8)))
    ...
    public void getUserTweets_ShouldUserNotFound() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(PathConstants.UI_V1_TWEETS + PathConstants.USER_USER_ID, 99)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isNotFound())
                .andExpect(MockMvcResultMatchers.jsonPath("$", Matchers.is(String.format(ErrorMessage.USER_ID_NOT_FOUND, 99))));
    }
    ...
    public void getUserTweets_ShouldUserHavePrivateProfile() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(PathConstants.UI_V1_TWEETS + PathConstants.USER_USER_ID, 3)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isNotFound())
                .andExpect(jsonPath("$", Matchers.is(ErrorMessage.USER_NOT_FOUND)));
    }
    ...
    public void getUserTweets_ShouldUserBlocked() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(PathConstants.UI_V1_TWEETS + PathConstants.USER_USER_ID, 6)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isBadRequest())
                .andExpect(jsonPath("$", Matchers.is(ErrorMessage.USER_PROFILE_BLOCKED)));
    }
    ...
    public void getUserMediaTweets() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(PathConstants.UI_V1_TWEETS + PathConstants.MEDIA_USER_USER_ID, TestConstants.USER_ID)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isOk())
    ...
    public void getUserMediaTweets_ShouldUserNotFound() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(PathConstants.UI_V1_TWEETS + PathConstants.MEDIA_USER_USER_ID, 99)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isNotFound())
                .andExpect(MockMvcResultMatchers.jsonPath("$", Matchers.is(String.format(ErrorMessage.USER_ID_NOT_FOUND, 99))));
    }
    ...
    public void getUserMediaTweets_ShouldUserHavePrivateProfile() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(PathConstants.UI_V1_TWEETS + PathConstants.MEDIA_USER_USER_ID, 3)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isNotFound())
                .andExpect(jsonPath("$", Matchers.is(ErrorMessage.USER_NOT_FOUND)));
    }
    ...
    public void getUserMediaTweets_ShouldUserBlocked() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(PathConstants.UI_V1_TWEETS + PathConstants.MEDIA_USER_USER_ID, 6)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isBadRequest())
                .andExpect(jsonPath("$", Matchers.is(ErrorMessage.USER_PROFILE_BLOCKED)));
    }
    ...
    public void getUserTweetImages() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(PathConstants.UI_V1_TWEETS + PathConstants.IMAGES_USER_ID, 1)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$[*]", hasSize(1)))
    ...
    public void getUserTweetImages_ShouldUserNotFound() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(PathConstants.UI_V1_TWEETS + PathConstants.IMAGES_USER_ID, 99)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isNotFound())
                .andExpect(MockMvcResultMatchers.jsonPath("$", Matchers.is(String.format(ErrorMessage.USER_ID_NOT_FOUND, 99))));
    }
    ...
    public void getUserTweetImages_ShouldUserHavePrivateProfile() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(PathConstants.UI_V1_TWEETS + PathConstants.IMAGES_USER_ID, 3)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isNotFound())
                .andExpect(jsonPath("$", Matchers.is(ErrorMessage.USER_NOT_FOUND)));
    }
    ...
    public void getUserTweetImages_ShouldUserBlocked() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(PathConstants.UI_V1_TWEETS + PathConstants.IMAGES_USER_ID, 6)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isBadRequest())
                .andExpect(jsonPath("$", Matchers.is(ErrorMessage.USER_PROFILE_BLOCKED)));
    }
    ...
    public void getTweetAdditionalInfoById() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(PathConstants.UI_V1_TWEETS + PathConstants.TWEET_ID_INFO, 43)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.text").value(TestConstants.TWEET_TEXT))
                .andExpect(jsonPath("$.replyType").value(ReplyType.EVERYONE.toString()))
    ...
    public void getTweetAdditionalInfoById_ShouldNotFound() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(PathConstants.UI_V1_TWEETS + PathConstants.TWEET_ID_INFO, 99)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isNotFound())
                .andExpect(jsonPath("$", Matchers.is(ErrorMessage.TWEET_NOT_FOUND)));
    }
    ...
    public void getTweetAdditionalInfoById_ShouldTweetDeleted() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(PathConstants.UI_V1_TWEETS + PathConstants.TWEET_ID_INFO, 49)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isBadRequest())
                .andExpect(jsonPath("$", Matchers.is(ErrorMessage.TWEET_DELETED)));
    }
    ...
    public void getTweetAdditionalInfoById_ShouldUserHavePrivateProfile() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(PathConstants.UI_V1_TWEETS + PathConstants.TWEET_ID_INFO, 50)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isNotFound())
                .andExpect(jsonPath("$", Matchers.is(ErrorMessage.USER_NOT_FOUND)));
    }
    ...
    public void getTweetAdditionalInfoById_ShouldUserBlocked() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(PathConstants.UI_V1_TWEETS + PathConstants.TWEET_ID_INFO, 51)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isBadRequest())
                .andExpect(jsonPath("$", Matchers.is(ErrorMessage.USER_PROFILE_BLOCKED)));
    }
    ...
    public void getRepliesByTweetId() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(PathConstants.UI_V1_TWEETS + PathConstants.TWEET_ID_REPLIES, 40)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$[*]", hasSize(1)))
    ...
    public void getRepliesByTweetId_ShouldNotFound() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(PathConstants.UI_V1_TWEETS + PathConstants.TWEET_ID_REPLIES, 99)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isNotFound())
                .andExpect(jsonPath("$", Matchers.is(ErrorMessage.TWEET_NOT_FOUND)));
    }
    ...
    public void getRepliesByTweetId_ShouldTweetDeleted() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(PathConstants.UI_V1_TWEETS + PathConstants.TWEET_ID_REPLIES, 49)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isBadRequest())
                .andExpect(jsonPath("$", Matchers.is(ErrorMessage.TWEET_DELETED)));
    }
    ...
    public void getRepliesByTweetId_ShouldUserHavePrivateProfile() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(PathConstants.UI_V1_TWEETS + PathConstants.TWEET_ID_REPLIES, 50)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isNotFound())
                .andExpect(jsonPath("$", Matchers.is(ErrorMessage.USER_NOT_FOUND)));
    }
    ...
    public void getRepliesByTweetId_ShouldUserBlocked() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(PathConstants.UI_V1_TWEETS + PathConstants.TWEET_ID_REPLIES, 51)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isBadRequest())
                .andExpect(jsonPath("$", Matchers.is(ErrorMessage.USER_PROFILE_BLOCKED)));
    }
    ...
    public void getQuotesByTweetId() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(PathConstants.UI_V1_TWEETS + PathConstants.TWEET_ID_QUOTES, 40)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$[*]", hasSize(1)))
    ...
    public void getQuotesByTweetId_ShouldNotFound() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(PathConstants.UI_V1_TWEETS + PathConstants.TWEET_ID_QUOTES, 99)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isNotFound())
                .andExpect(jsonPath("$", Matchers.is(ErrorMessage.TWEET_NOT_FOUND)));
    }
    ...
    public void getQuotesByTweetId_ShouldTweetDeleted() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(PathConstants.UI_V1_TWEETS + PathConstants.TWEET_ID_QUOTES, 49)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isBadRequest())
                .andExpect(jsonPath("$", Matchers.is(ErrorMessage.TWEET_DELETED)));
    }
    ...
    public void getQuotesByTweetId_ShouldUserHavePrivateProfile() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(PathConstants.UI_V1_TWEETS + PathConstants.TWEET_ID_QUOTES, 50)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isNotFound())
                .andExpect(jsonPath("$", Matchers.is(ErrorMessage.USER_NOT_FOUND)));
    }
    ...
    public void getQuotesByTweetId_ShouldUserBlocked() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(PathConstants.UI_V1_TWEETS + PathConstants.TWEET_ID_QUOTES, 51)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isBadRequest())
                .andExpect(jsonPath("$", Matchers.is(ErrorMessage.USER_PROFILE_BLOCKED)));
    }
    ...
    public void getMediaTweets() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(PathConstants.UI_V1_TWEETS + PathConstants.MEDIA)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$[*]", hasSize(1)))
                .andExpect(jsonPath("$[0].id").value(45L))
    ...
    public void getTweetsWithVideo() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(PathConstants.UI_V1_TWEETS + PathConstants.VIDEO)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$[*]", hasSize(1)))
                .andExpect(jsonPath("$[0].id").value(42L))
    ...
    public void getFollowersTweets() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(PathConstants.UI_V1_TWEETS + PathConstants.FOLLOWER)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$[*]", hasSize(1)))
                .andExpect(jsonPath("$[0].id").value(45L))
    ...
    public void getTaggedImageUsers() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(PathConstants.UI_V1_TWEETS + PathConstants.IMAGE_TAGGED, 45)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isOk())
    ...
    public void createTweet_ShouldTweetTextLengthMoreThan280Symbols() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.post(PathConstants.UI_V1_TWEETS)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID)
                        .content(mapper.writeValueAsString(tweetRequest))
                        .contentType(MediaType.APPLICATION_JSON_VALUE))
                .andExpect(status().isBadRequest())
                .andExpect(jsonPath("$", Matchers.is(ErrorMessage.INCORRECT_TWEET_TEXT_LENGTH)));
    }
    ...
    public void deleteTweet() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.delete(PathConstants.UI_V1_TWEETS + PathConstants.TWEET_ID, 40)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isOk())
    ...
    public void deleteTweet_ShouldTweetNotFoundById() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.delete(PathConstants.UI_V1_TWEETS + PathConstants.TWEET_ID, 99)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isNotFound())
                .andExpect(jsonPath("$", Matchers.is(ErrorMessage.TWEET_NOT_FOUND)));
    }
    ...
    public void searchTweets() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(PathConstants.UI_V1_TWEETS + PathConstants.SEARCH_TEXT, "test")
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isOk())
    ...
    public void replyTweet() throws Exception {
        ...
        tweetRequest.setReplyType(ReplyType.EVERYONE);
        mockMvc.perform(post(PathConstants.UI_V1_TWEETS + PathConstants.REPLY_USER_ID_TWEET_ID, 2, 43)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID)
                        .content(mapper.writeValueAsString(tweetRequest))
                        .contentType(MediaType.APPLICATION_JSON_VALUE))
                .andExpect(status().isOk())
    ...
    public void replyTweet_ShouldTweetNotFound() throws Exception {
        ...
        tweetRequest.setText("test reply");
        tweetRequest.setReplyType(ReplyType.EVERYONE);
        mockMvc.perform(post(PathConstants.UI_V1_TWEETS + PathConstants.REPLY_USER_ID_TWEET_ID, 2, 99)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID)
                        .content(mapper.writeValueAsString(tweetRequest))
                        .contentType(MediaType.APPLICATION_JSON_VALUE))
                .andExpect(status().isNotFound())
    ...
    public void replyTweet_ShouldTweetDeleted() throws Exception {
        ...
        tweetRequest.setText("test reply");
        tweetRequest.setReplyType(ReplyType.EVERYONE);
        mockMvc.perform(post(PathConstants.UI_V1_TWEETS + PathConstants.REPLY_USER_ID_TWEET_ID, 2, 49)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID)
                        .content(mapper.writeValueAsString(tweetRequest))
                        .contentType(MediaType.APPLICATION_JSON_VALUE))
                .andExpect(status().isBadRequest())
    ...
    public void replyTweet_ShouldUserHavePrivateProfile() throws Exception {
        ...
        tweetRequest.setText("test reply");
        tweetRequest.setReplyType(ReplyType.EVERYONE);
        mockMvc.perform(post(PathConstants.UI_V1_TWEETS + PathConstants.REPLY_USER_ID_TWEET_ID, 2, 50)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID)
                        .content(mapper.writeValueAsString(tweetRequest))
                        .contentType(MediaType.APPLICATION_JSON_VALUE))
                .andExpect(status().isNotFound())
    ...
    public void replyTweet_ShouldUserBlocked() throws Exception {
        ...
        tweetRequest.setText("test reply");
        tweetRequest.setReplyType(ReplyType.EVERYONE);
        mockMvc.perform(post(PathConstants.UI_V1_TWEETS + PathConstants.REPLY_USER_ID_TWEET_ID, 2, 51)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID)
                        .content(mapper.writeValueAsString(tweetRequest))
                        .contentType(MediaType.APPLICATION_JSON_VALUE))
                .andExpect(status().isBadRequest())
