...
public class ScheduledTweetControllerTest {
    ...
    public void getScheduledTweets() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(PathConstants.UI_V1_TWEETS + PathConstants.SCHEDULE)
    ...
    public void createScheduledTweet() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.post(PathConstants.UI_V1_TWEETS + PathConstants.SCHEDULE)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID)
    ...
    public void updateScheduledTweet() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.put(PathConstants.UI_V1_TWEETS + PathConstants.SCHEDULE)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID)
                        .content(mapper.writeValueAsString(tweetRequest))
                        .contentType(MediaType.APPLICATION_JSON_VALUE))
                .andExpect(status().isOk())
    ...
    public void deleteScheduledTweets() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.delete(PathConstants.UI_V1_TWEETS + PathConstants.SCHEDULE)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID)
