...
public class RetweetControllerTest {
    ...
    public void getUserRetweetsAndReplies() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(PathConstants.UI_V1_TWEETS + PathConstants.REPLIES_USER_ID, TestConstants.USER_ID)
    ...
    public void getUserRetweetsAndReplies_ShouldUserNotFound() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(PathConstants.UI_V1_TWEETS + PathConstants.REPLIES_USER_ID, 99)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
    ...
    public void getUserRetweetsAndReplies_ShouldUserHavePrivateProfile() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(PathConstants.UI_V1_TWEETS + PathConstants.REPLIES_USER_ID, 3)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isNotFound())
    ...
    public void getUserRetweetsAndReplies_ShouldUserBlockedByOtherUser() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(PathConstants.UI_V1_TWEETS + PathConstants.REPLIES_USER_ID, 6)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
    ...
    public void getRetweetedUsersByTweetId() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(PathConstants.UI_V1_TWEETS + PathConstants.TWEET_ID_RETWEETED_USERS, 40)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$[*]", hasSize(1)))
    ...
    public void getRetweetedUsersByTweetId_ShouldTweetNotFound() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(PathConstants.UI_V1_TWEETS + PathConstants.TWEET_ID_RETWEETED_USERS, 99)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isNotFound())
    ...
    public void getRetweetedUsersByTweetId_ShouldTweetDeleted() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(PathConstants.UI_V1_TWEETS + PathConstants.TWEET_ID_RETWEETED_USERS, 49)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isBadRequest())
