...
public class LikeTweetControllerTest {
    ...
    public void getUserLikedTweets() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(PathConstants.UI_V1_TWEETS + PathConstants.LIKED_USER_USER_ID,  TestConstants.USER_ID)
    ...
    public void getUserLikedTweets_ShouldUserNotFound() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(PathConstants.UI_V1_TWEETS + PathConstants.LIKED_USER_USER_ID, 99)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
    ...
    public void getUserLikedTweets_ShouldUseHavePrivateProfile() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(PathConstants.UI_V1_TWEETS + PathConstants.LIKED_USER_USER_ID, 3)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isNotFound())
    ...
    public void getUserLikedTweets_ShouldUseProfileBlocked() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(PathConstants.UI_V1_TWEETS + PathConstants.LIKED_USER_USER_ID, 6)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
    ...
    public void getLikedUsersByTweetId() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(PathConstants.UI_V1_TWEETS + PathConstants.TWEET_ID_LIKED_USERS, 40)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$[*]", hasSize(1)))
    ...
    public void getLikedUsersByTweetId_ShouldTweetNotFound() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(PathConstants.UI_V1_TWEETS + PathConstants.TWEET_ID_LIKED_USERS, 99)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isNotFound())
    ...
    public void getLikedUsersByTweetId_ShouldTweetDeleted() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(PathConstants.UI_V1_TWEETS + PathConstants.TWEET_ID_LIKED_USERS, 49)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isBadRequest())
