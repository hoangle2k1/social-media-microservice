...
public class PollControllerTest {
    ...
    public void createTweetWithPoll() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.post(PathConstants.UI_V1_TWEETS + PathConstants.POLL)
    ...
    public void createTweetWithPoll_ShouldIncorrectPoolChoicesSizeIs1() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.post(PathConstants.UI_V1_TWEETS + PathConstants.POLL)
                ...
                .andExpect(jsonPath("$", Matchers.is(ErrorMessage.INCORRECT_POLL_CHOICES)));
    }
    ...
    public void createTweetWithPoll_ShouldIncorrectPoolChoicesTextLengthIs0() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.post(PathConstants.UI_V1_TWEETS + PathConstants.POLL)
                        ...
                        .contentType(MediaType.APPLICATION_JSON_VALUE))
                .andExpect(status().isBadRequest())
                .andExpect(jsonPath("$", Matchers.is(ErrorMessage.INCORRECT_CHOICE_TEXT_LENGTH)));
    }
    ...
    public void voteInPoll() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.post(PathConstants.UI_V1_TWEETS + PathConstants.VOTE)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID)
    ...
    public void voteInPoll_ShouldPollNotFound() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.post(PathConstants.UI_V1_TWEETS + PathConstants.VOTE)
                ...
                .andExpect(jsonPath("$", Matchers.is(ErrorMessage.POLL_NOT_FOUND)));
    }
    ...
    public void voteInPoll_ShouldPollChoiceNotFound() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.post(PathConstants.UI_V1_TWEETS + PathConstants.VOTE)
                        ...
                        .contentType(MediaType.APPLICATION_JSON_VALUE))
                .andExpect(status().isNotFound())
                .andExpect(jsonPath("$", Matchers.is(ErrorMessage.POLL_CHOICE_NOT_FOUND)));
    }
