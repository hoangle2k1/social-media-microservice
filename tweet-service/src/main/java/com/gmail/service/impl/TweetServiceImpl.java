...
import com.gmail.feign.ImageClient;
...
import com.gmail.repository.TweetImageRepository;
...
public class TweetServiceImpl implements TweetService {
    ...
    public TweetProjection changeTweetReplyType(Long tweetId, ReplyType replyType) {
        ...
        if (!tweet.getAuthor().getId().equals(authUserId)) {
            throw new ApiRequestException(ErrorMessage.TWEET_NOT_FOUND, HttpStatus.NOT_FOUND);
        }
