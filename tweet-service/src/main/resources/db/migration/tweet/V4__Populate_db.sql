...
INSERT INTO users(id, full_name, username, private_profile, active, about, avatar, muted_direct_messages, pinned_tweet_id) VALUES (5, 'hoangle', 'Кот Бегемот', false, true, 'Hello twitter!', 'https://perfumeweb2.s3.eu-central-1.amazonaws.com/68a7b0d5-2b0c-493e-85ff-098725c52ecc_Cl5DjoUWYAAslnd.jfif', false, null);
-- user_subscriptions
