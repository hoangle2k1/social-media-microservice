...
public class TopicControllerTest {
    ...
    public void getTopicsByIds() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.post(PathConstants.UI_V1_TOPICS + PathConstants.SUGGESTED)
    ...
    public void getTopicsByCategories() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.post(PathConstants.UI_V1_TOPICS + PathConstants.CATEGORY)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID)
                        .content(mapper.writeValueAsString(topicsRequest))
                        .contentType(MediaType.APPLICATION_JSON_VALUE))
                .andExpect(status().isOk())
    ...
    public void getFollowedTopics() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(PathConstants.UI_V1_TOPICS + PathConstants.FOLLOWED)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isOk())
    ...
    public void getFollowedTopicsByUserId() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(PathConstants.UI_V1_TOPICS + PathConstants.FOLLOWED_USER_ID, 2)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$[*]", hasSize(4)));
    }
    ...
    public void getFollowedTopicsByUserId_UserHavePrivateProfile() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(PathConstants.UI_V1_TOPICS + PathConstants.FOLLOWED_USER_ID, 3)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
    ...
    public void getFollowedTopicsByUserId_UserNotFound() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(PathConstants.UI_V1_TOPICS + PathConstants.FOLLOWED_USER_ID, 99)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isNotFound())
    ...
    public void getFollowedTopicsByUserId_UserBlocked() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(PathConstants.UI_V1_TOPICS + PathConstants.FOLLOWED_USER_ID, 5)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
    ...
    public void getNotInterestedTopics() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(PathConstants.UI_V1_TOPICS + PathConstants.NOT_INTERESTED)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$[*]", hasSize(2)));
    }
    ...
    public void processNotInterestedTopic_addTopic() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(PathConstants.UI_V1_TOPICS + PathConstants.NOT_INTERESTED_TOPIC_ID, 1001)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isOk())
    ...
    public void processNotInterestedTopic_removeTopic() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(PathConstants.UI_V1_TOPICS + PathConstants.NOT_INTERESTED_TOPIC_ID, 1018)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isOk())
    ...
    public void processNotInterestedTopic_NotFound() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(PathConstants.UI_V1_TOPICS + PathConstants.NOT_INTERESTED_TOPIC_ID, 1)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isNotFound())
                .andExpect(jsonPath("$", Matchers.is(ErrorMessage.TOPIC_NOT_FOUND)));
    }

    @Test
    @DisplayName("[200] GET /ui/v1/topics/follow/1001 - Follow topic")
    public void processFollowTopic_followTopic() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(PathConstants.UI_V1_TOPICS + PathConstants.FOLLOW_TOPIC_ID, 1001)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$", is(true)));
    }
    ...
    public void processFollowTopic_unfollowTopic() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(PathConstants.UI_V1_TOPICS + PathConstants.FOLLOW_TOPIC_ID, 1008)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$", is(false)));
    }
    ...
    public void processFollowTopic_NotFound() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(PathConstants.UI_V1_TOPICS + PathConstants.FOLLOW_TOPIC_ID, 1)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isNotFound())
                .andExpect(jsonPath("$", Matchers.is(ErrorMessage.TOPIC_NOT_FOUND)));
    }
